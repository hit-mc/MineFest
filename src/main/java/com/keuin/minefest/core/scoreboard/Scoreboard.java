...
/**
 * A scoreboard is an API-related Minecraft scoreboard implementation.
 * The interface is a high-level abstraction which is independent from
 * any specific mod loader and mod API (such as Spigot, Forge, Fabric).
 ...
 */
public interface Scoreboard<T extends Number> {
